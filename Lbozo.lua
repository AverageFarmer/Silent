...
elseif game.PlaceId == 8349889591 then
    ...
    local Maps = {
        ...
        ["jjk"] = {
            Ground = {
                CFrame.new(381.301, 123.357, -76.2126) ,
                CFrame.new(380.97, 123.357, -80.0194) ,
                CFrame.new(381.251, 123.357, -74.1054),
                CFrame.new(381.055, 123.357, -78.0402),
                CFrame.new(379.491, 123.957, -73.8823),
                CFrame.new(379.457, 123.357, -78.1883),
                CFrame.new(379.206, 123.964, -80.2178),
                CFrame.new(377.771, 123.353, -73.8136),
                CFrame.new(377.733, 123.357, -75.7505),
                CFrame.new(377.844, 123.357, -78.0667),
                CFrame.new(377.607, 123.353, -80.134),
                CFrame.new(376.053, 123.353, -73.7824),
                CFrame.new(376.162, 123.353, -75.5871),
                CFrame.new(376.146, 123.353, -78.1184),
                CFrame.new(376.131, 123.353, -80.3606),
