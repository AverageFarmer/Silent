            ...
            if playerCharacter then
                ...
                if playerHumanoidRP and playerHumanoid then
                    ...
                    if onScreen and playerHumanoid.Health > 0 then
                        ...
                        if workspace:FindPartOnRayWithIgnoreList(Ray.new(CCF, (playerHumanoidRP.Position-CCF).Unit * 9e9),{Player.Character})  then--RayCast(CCF, (playerHumanoidRP.Position-CCF).Unit, 9e9, {Player}) then
