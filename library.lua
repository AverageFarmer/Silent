...
local NotificationFrame = game:GetObjects("rbxassetid://9485122546")[1]
...
function SolarisLib:New(Config)
    ...
    function TabHolder:Tab(text)
        ...
        function SectionHold:Section(text)
            ...
            function ItemHold:Textbox(text,disappear, default, callback)
                ...
                TextboxFrame.Box.Text = default or ""
